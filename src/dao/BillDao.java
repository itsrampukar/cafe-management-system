...
public class BillDao {
    ...
    public static void save(Bill bill){
        String query = "insert into bill values('"+bill.getId()+"','"+bill.getTablenumber()+"','"+bill.getName()+"','"+bill.getMobileNumber()+"','"+bill.getEmail()+"','"+bill.getDate()+"','"+bill.getTotal()+"','"+bill.getCreatedBy()+"')";
    ...
    public static ArrayList<Bill> getAllRecordsByInc(String date){
        ...
        try{
            ...
            bill.setTablenumber(rs.getString("tablenumber"));
