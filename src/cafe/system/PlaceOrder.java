...
public class PlaceOrder extends javax.swing.JFrame {
    ...
    public void balance() {
        int total = Integer.parseInt(lblGrandTotal.getText());
        int pay = Integer.parseInt(txtReceivedAmount.getText());

        int blc = pay - total;

        llblReturnAmount.setText(String.valueOf(blc));
    }
    ...
    private void initComponents() {
        ...
        llblReturnAmount = new javax.swing.JLabel();
        txtReceivedAmount = new javax.swing.JTextField();
        jLabel15 = new javax.swing.JLabel();

        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/place order.jpg"))); // NOI18N
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1486, 11, 40, -1));
        ...
        getContentPane().add(txtCusName, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 300, 250, -1));
        ...
        txtCusMobileNo.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txtCusMobileNo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtCusMobileNoKeyReleased(evt);
            }
        });
        getContentPane().add(txtCusMobileNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 370, 250, -1));
        ...
        getContentPane().add(jComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 180, 250, -1));

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Category");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 120, -1, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 160, 250, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 280, 250, -1));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Name");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 130, 40, -1));

        txtProName.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtProName, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 160, 250, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Price");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 130, 40, -1));

        txtProPrice.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        getContentPane().add(txtProPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 160, 250, -1));

        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Quantity");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 190, -1, -1));
        ...
        getContentPane().add(jSpinner1, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 220, 250, -1));

        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Total");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 190, 40, -1));
        ...
        getContentPane().add(txtProTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 220, 250, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 260, -1, -1));
        ...
        getContentPane().add(btnAddToCart, new org.netbeans.lib.awtextra.AbsoluteConstraints(1310, 260, -1, -1));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 320, 611, 388));

        jLabel14.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel14.setText("Grand Total: Rs.");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 730, -1, -1));
        ...
        getContentPane().add(lblGrandTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 730, 40, -1));
        ...
        getContentPane().add(btnGenerateBillPrint, new org.netbeans.lib.awtextra.AbsoluteConstraints(1250, 750, -1, -1));
        ...
        getContentPane().add(txtCusEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 430, 250, -1));

        jLabel19.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(255, 255, 255));
        jLabel19.setText("Email");
        getContentPane().add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 410, -1, -1));

        jLabel17.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel17.setText("Return Amount Rs.");
        getContentPane().add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 790, 120, -1));

        jLabel18.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel18.setText("Received Amount Rs.");
        getContentPane().add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 760, -1, -1));

        llblReturnAmount.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        llblReturnAmount.setForeground(new java.awt.Color(255, 255, 255));
        llblReturnAmount.setText("000");
        getContentPane().add(llblReturnAmount, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 790, -1, -1));

        txtReceivedAmount.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        txtReceivedAmount.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtReceivedAmountActionPerformed(evt);
            }
        });
        getContentPane().add(txtReceivedAmount, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 760, 71, -1));

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/place order.jpg"))); // NOI18N
    ...
    private void btnGenerateBillPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateBillPrintActionPerformed
        ...
        balance();
        String tablenumber = (String) jComboBox.getSelectedItem();
        String customerName = txtCusName.getText();
        String customerMobileNumber = txtCusMobileNo.getText();
        String customerEmail = txtCusEmail.getText();
        ...
        String Return = llblReturnAmount.getText();
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        ArrayList<TableNumber> list1 = TableNumberDao.getAllRecords();
        Iterator<TableNumber> itr1 = list1.iterator();
        while (itr1.hasNext()) {
            TableNumber tablenumberObj = itr1.next();
            jComboBox.addItem(tablenumberObj.getTablenumber());
        }
    ...
    private javax.swing.JLabel llblReturnAmount;
